...
@SerializableAs(value = "SimpleBookselfLocation")
public class SimpleLocation implements ConfigurationSerializable {
    ...
    public static String getBlockStringFromLocation(Location l) {
    	return l.getWorld().getName() + "," + l.getBlockX() + "," + l.getBlockY() + "," + l.getBlockZ() + ",0,0";
    }
}
